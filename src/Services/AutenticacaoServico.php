...
class AutenticacaoServico {
    ...
    public static function exigirLogin():void {
        ...
        if( !isset($_SESSION['id'] ) ){
            Utils::redirecionePara("../login.php?acesso_proibido");
        }
    }
    ...
    public static function login(int $valorId, string $valorNome, string $valorTipo):void {
        ...
        Utils::redirecionePara("admin/");
    }

    public static function logout():void{
        self::iniciarSessao();
        session_destroy();
        Utils::redirecionePara('../login.php?saiu');
    }
    ...
    public static function exigirAdmin():void{
        ...
        if($_SESSION['tipo'] !=='admin'){
            Utils::redirecionePara("nao-autorizado.php");
        }
    }
